...
const cardBodyTextDefaultProps = {
    color: 'grey',
...
const Card = system(cardDefaultProps);
const CardFooter = system(footerDefaultProps);
const CardTitle = styled(HeadingFive)``;
...
CardBodyText.defaultProps = cardBodyTextDefaultProps;
