...
function Radio(props) {
    ...
    return (
        <Label color={disabled && disabledTint} pl={labelIndent} {...props}>
            <BaseRadio
                checked={checked}
...
Radio.propTypes = {
    ...
    labelIndent: PropTypes.number,
    onChange: PropTypes.func.isRequired,
    radioBorderColor: PropTypes.string,
    radioBorderRadius: PropTypes.string,
    radioBorderWidth: PropTypes.number,
    radioHoverColor: PropTypes.string,
